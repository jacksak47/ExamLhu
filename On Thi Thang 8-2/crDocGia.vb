...
Public Class crDocGia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "On_Thi_Thang_8_2.crDocGia.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_TuNgay() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_DenNgay() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcrDocGia
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crDocGia = New crDocGia()
        rpt.Site = Me.Site
        Return rpt
    End Function
